  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This sidebar always overlays the content — it never reserves
            layout space, regardless of variant or collapsed/expanded state. */}
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow group-data-[state=expanded]:border-8 group-data-[state=expanded]:border-main-light"
          >
            {children}
          </div>
        </div>
